...
A coding agent discovers a skill's name and description first, then loads the instructions when the skill is selected. A clear description helps it choose the right procedure.
...
- [Agent Skills: structure and discovery](https://developers.openai.com/codex/skills/)

- [VS Code reusable prompt files](https://code.visualstudio.com/docs/agent-customization/prompt-files)
