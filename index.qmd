...
# <span class="visually-hidden">Detecting warnings</span> {#section-2}
<!-- column layout -->
...
# <span class="visually-hidden">Portability</span> {#section-3}
<!-- column layout -->
...
# <span class="visually-hidden">Dependency management</span> {#section-5}
<!-- column layout -->
