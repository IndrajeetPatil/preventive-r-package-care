...
Exclude agent instruction files, skill directories, and saved prompts from package tarballs via `.Rbuildignore`.
...
pkgdown publishes this for you: an [`llms.txt`](https://llmstxt.org/) index at the site root, plus a Markdown twin of every rendered page.
...
- [R package build exclusions](https://cran.r-project.org/doc/manuals/r-release/R-exts.html#Building-package-tarballs)

- [pkgdown docs for LLMs](https://pkgdown.r-lib.org/reference/build_llm_docs.html)
