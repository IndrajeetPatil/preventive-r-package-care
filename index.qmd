...
Use scheduled [GHA workflow](https://github.com/IndrajeetPatil/statsExpressions/blob/main/.github/workflows/R-CMD-check-devel.yaml) to automate checking breakages.
...
# Further reading {data-visibility="uncounted"}
...
- Wickham, H., and Bryan, J. (2023). [*R Packages*](https://r-pkgs.org/) (2nd edition). O'Reilly.
...
{{< fa brands linkedin >}} [LikedIn](https://www.linkedin.com/in/indrajeet-patil-ph-d-397865174/)
