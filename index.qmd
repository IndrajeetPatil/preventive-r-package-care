...
# <span class="visually-hidden">LLM-readiness</span> {#section-6 aria-label="LLM-readiness: overview"}
<!-- column layout -->
...
Exclude agent instruction files, skill directories, and saved prompts from package tarballs via [`.Rbuildignore`](https://cran.r-project.org/doc/manuals/r-release/R-exts.html#Building-package-tarballs).
