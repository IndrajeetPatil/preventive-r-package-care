...
- If you set `warning=FALSE` in vignettes, this only suppresses warnings in the rendered output. When users run this code interactively, they will still see the suppressed warnings. [Ostrich policy](https://en.wikipedia.org/wiki/Ostrich_policy){target='_blank'} never works for software development.
