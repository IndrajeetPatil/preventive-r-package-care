...
knitr::include_graphics("media/technical_debt.png")
```
...
The initial work you will put into achieving green checks will pay dividends in the long run. And, once a check is green, you only need to make sure that it stays that way for every PR.
...
#| echo: false
#| out-width: "100%"
knitr::include_graphics("media/bike-fall.jpeg")
```
...
It might not be feasible to implement all workflows in one go, especially whey they will be marked as failed as long as all relevant issues have been dealt with.
