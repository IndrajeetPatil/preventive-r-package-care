...
```{r, echo=FALSE}
knitr::include_graphics("media/preventive-care.png")
```
...
Based on research, *Accelerate* (Forsgren, Humble, & Kim, 2018) argue that the key difference between high-performing vs low-performing software teams is *the ability to make a release at the drop of a hat*.
...
E.g. if your package relies on `{ggside}`, you may have seen [this warning](https://github.com/jtlandis/ggside/issues/39){target='_blank'}.
...
It is possible to build a robust automation infrastructure for R package development that can improve user experience and make long-term package development more reliable and sustainable.
