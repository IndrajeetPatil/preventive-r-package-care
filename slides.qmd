...
**To guarantee a good user experience, you need to make sure that all examples in these documents are working as expected.**
...
**To guarantee a good user experience, you need to make sure that the documentation is up-to-date.**
...
Dependencies (code that your source code relies on) are an inevitable part of package development. But not all dependencies are created equal. Some have a broader scope because they are needed at runtime; i.e. your package won't work without them. Others have a narrow scope; e.g. because they are needed only for testing or for examples.
...
**To guarantee a good user experience and to reduce maintenance workload, you need to make sure that builds pass both in the presence and absence of soft dependencies.**
