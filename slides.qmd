...
Given that soft dependencies are optional, the package should be insured against their unavailability. CRAN ascertains this in the additional, ["noSuggests" check](https://www.stats.ox.ac.uk/pub/bdr/noSuggests/){target='_blank'}.
...
**How to make sure *all* weak dependencies are being conditionally used?**
...
## Conditional usage of dependencies {.smaller}
